...
app = FastAPI(
    title="Genomic Cancer Detection Pipeline API - AWS",
    description="API Agentic AI pour pipeline de détection de cancer (Cloud-native AWS)",
    version="1.0.0"
)
...
async def upload_and_process(
    ...
    """
    Upload FASTQ files and start pipeline via Step Functions.
    """
